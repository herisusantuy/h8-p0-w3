...
/*Problem
Diberikan sebuah function tentukanDeretGeometri(arr) yang menerima 
satu parameter berupa array yang terdiri dari angka. 
Function tersebut akan mengembalikan true jika array dari 
parameter tersebut merupakan deret geometri. 
Deret geometri adalah sebuah deret dimana perbedaan setiap 
...
function tentukanDeretGeometri(arr) {
  var arrAwal = arr[1]/arr[0]
  var arrMod =0
  for (var i=0;i < arr.length-1;i++){
      arrMod = arr[i+1]/arr[i]
      if (arrMod % arrAwal !== 0){
          return false
      }
      else {
